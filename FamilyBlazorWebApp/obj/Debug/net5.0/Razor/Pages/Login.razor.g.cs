#pragma checksum "C:\Users\kkash\RiderProjects\DNP1Assignment1\FamilyBlazorWebApp\Pages\Login.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c6d1199f6f8cff93fbe7c223c2e19b3111280a72"
// <auto-generated/>
...
#nullable disable
    ...
    public partial class Login : Microsoft.AspNetCore.Components.ComponentBase
    {
        ...
        {
            __builder.AddMarkupContent(0, @"<div class=""row page-background-class justify-content-center align-items-center""><div class=""col-4 overflow-auto""><div class=""loginBox""><div class=""form-group""><h1 id=""WelcomeMessage"">Welcome to Family Blazor</h1></div>
            
            <br>
            
            <div class=""form-group inputFields""><label class=""inputForLogin"">User name:</label>
                <input type=""text"" placeholder=""User name""></div>

            <br>

            <div class=""form-group inputFields""><label class=""inputForLogin"">Password:</label>
                <input type=""password"" placeholder=""password""></div>

            <br>

            <div class=""form-group""><p class=""action""><button class=""btn btn-outline-dark"" type=""submit"">Login</button></p></div>
